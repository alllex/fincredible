    ...
    <div class="d-flex justify-content-center mb-2">
        <div class="card mb-3" style="max-width: 540px;">
            ...
            <div class="row no-gutters">
                ...
                <div class="col-md-2">
                    <ul class="fa-ul">
                      <li><span class="fa-li"><i class="fas fa-ruler"></i></span>{{ distance }}km</li>
                      <li><span class="fa-li"><i class="fas fa-clock"></i></span>{{ duration }}h</li>
                      <li><span class="fa-li"><i class="fas fa-layer-group"></i></span>
            ...
            <div class="row no-gutters">
                <div class="col-md-12 p-1">
                    <img :src="service" class="m-1" v-for="service in services" :key="service">
                </div>
            </div>
        </div>
    </div>
